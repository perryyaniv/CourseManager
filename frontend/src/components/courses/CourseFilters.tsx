    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {t('courses.filters')}
          {activeCount > 0 && (
            <span className={`text-xs font-bold px-1.5 py-0.5 rounded-full ${open ? 'bg-white text-primary' : 'bg-white text-primary'}`}>
              {activeCount}
            </span>
          )}
        ...
        {!open && activeCount > 0 && (
          <div className="flex items-center gap-1.5 flex-wrap">
            {filters.status && (
              <span className="flex items-center gap-1 text-xs bg-primary/10 text-primary border border-primary/20 px-2 py-1 rounded-full">
                {filters.status}
