          ...
          <div className="absolute top-0 right-0 h-full w-72 bg-primary shadow-xl flex flex-col">
            ...
            <div className="px-4 py-3 border-b border-white/10">
              <form onSubmit={(e) => { handleSearch(e); setDrawerOpen(false); }} className="flex gap-2">
                ...
                />
                <button type="submit" className="px-3 bg-white/20 text-white rounded-md text-sm font-medium hover:bg-white/30">
                  חפש
                </button>
              </form>
            </div>
            ...
            <div className="px-4 py-4 border-t border-white/10">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => { clearAuth(); setDrawerOpen(false); }}
